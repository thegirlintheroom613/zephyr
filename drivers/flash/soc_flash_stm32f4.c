...
static int check_status(struct stm32f4x_flash *regs)
{
	...
	/* TODO: Investigate why flash writes raise FLASH_FLAG_PGPERR
	 * or FLASH_FLAG_PGSERR in some scenarios
	 */
...
DEVICE_AND_API_INIT(stm32f4x_flash, CONFIG_SOC_FLASH_STM32F4_DEV_NAME,
		    stm32f4_flash_init, &flash_data, NULL, POST_KERNEL,
